    ...
    <form x-data="addPessoa" action="post" class="mx-2 my-2" onsubmit="return false;">
        ...
        <div class="container flex">
            <ul class="border-collapse border border-gray-600 mr-2 w-1/2">
                ...
                <button type="button" x-on:click="showModal = true, pessoaId" class="w-full">Adicionar Filho</button>
                </li>
                </template>
            </ul>
            <div class="w-1/2">
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button type="button" x-on:click="addDependente(dependente, pessoaId)" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
                            Adicionar
                        </button>
