...
window.incluirPessoas = function () {
  ...
  var nodePessoa = document.querySelector("#Pessoa");
  var pessoa = document.querySelector("#pessoaHidden").cloneNode(true);
  var rato = document.querySelector("#listaPessoa");
  rato.innerHTML = nome;
  nodePessoa.appendChild(pessoa);
};

window.adicionarDependente = function () {
  var dependente = document.querySelector("#dependenteHidden").cloneNode(true);
  var ratinho = document.querySelector("#listaPessoa");
  var nomeDependente = prompt("Digite o nome do dependente:");
  ratinho.innerHTML = nomeDependente; // nodePessoa.appendChild(dependente);
